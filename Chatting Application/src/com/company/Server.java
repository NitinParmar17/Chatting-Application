...
public class Server implements ActionListener
{
    ...
    Server()
    {
        ...
        ImageIcon userImage = new ImageIcon(ClassLoader.getSystemResource("com/company/images/messi.jpg"));
...
//        textArea.setBackground(Color.lightGray);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            String out = textField.getText();        // input message taken

            sendTextToFile(out);   // to save chat in a text file

            textField.setText("");           // now input field made null
...
//            textArea.add(show);
    ...
    public static void sendTextToFile(String message) throws FileNotFoundException
    {
        ...
        try(  FileWriter f = new FileWriter("chat.txt",true);       // name of text file in which message will be saved. This file will be automatically created.
              PrintWriter p = new PrintWriter(new BufferedWriter(f));)     //  to write inside a file
        {
            p.println("Gaitonde: " + message);      // now printing messages in the file
        }
        catch (Exception e)
        {
            e.printStackTrace();
        ...
        try
        {
            ...
            while(true)
            {
                ...
                while (true)
                {
                    ...
                    // no need to write the code to add vertival to textarea
